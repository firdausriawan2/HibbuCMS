...
<body>
                ...
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        ...
                        <h4 class="text-dark font-weight-normal">Welcome to <span
                                class="font-weight-bold">{{ config('app.name', 'Laravel') }}</span>
                        </h4>
                        ...
                        <form method="POST" action="{{ route('login') }}" class="needs-validation" novalidate="">
                            ...
                            <div class="form-group">
                                ...
                                <input id="email" type="email"
                                    ...
                                    autocomplete="email" tabindex="1" value="{{ old('email') }}" required autofocus>
                                @error('email')
    ...
    <script src="{{ asset('BackEnd/BackEnd/assets/js/stisla.js') }}"></script>
